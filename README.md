...
**NoteHub** — NoteHub — це сучасний вебзастосунок для створення, перегляду та керування особистими нотатками. Проєкт розроблений із використанням Next.js та TypeScript і демонструє роботу з автентифікацією користувачів, захищеними маршрутами, глобальним станом та взаємодією з REST API.
